defmodule ExPostFactoDataFormatsTest do
  ...
  describe "backtest/3 with multiple input formats" do
    ...
    test "validates data by default" do
      ...
      assert String.contains?(reason, "invalid OHLC data")
    end
  ...
  describe "CSV parsing" do
    ...
    test "normalizes Adj Close to close" do
      csv_content = """
      ...
      # Should use "Adj Close" value for close price
      assert hd(data).close == 101.5
